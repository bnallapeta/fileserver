...
print("This is an interactive python script developed to enable interaction between you, the client and a File Service server \n")

# write switch conditions so that user can select CRUD operations

url = "http://nrbharath97.pythonanywhere.com/api/files/"
